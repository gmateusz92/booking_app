...
from .models import Apartment, Booking, Photo  # , Comment
    ...
    class Meta:
        ...
        widgets = {
            ...
            "longitude": forms.NumberInput(
                attrs={"class": "form-control narrow-input"}
            ),
    ...
    class Meta:
        ...
        widgets = {
            "check_in": forms.DateInput(
                attrs={"class": "form-control narrow-input", "type": "date"}
            ),
...
class CommentForm(forms.Form):
    ...
    rating = forms.IntegerField(
        label="Rating (1-5)", validators=[MinValueValidator(1), MaxValueValidator(5)]
    )
